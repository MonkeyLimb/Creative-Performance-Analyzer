...
export function buildHtmlFullReport(
  ...
  const title = options.title ?? "Creative Performance Report";
  const subtitle =
    options.reportingPeriod ??
    `Generated ${fmtDate(generatedAt)}${options.scopeLabel ? ` · ${options.scopeLabel}` : ""}`;
...
<div class="footer">Generated by Creative Performance Analyzer · ${escapeHtml(fmtDate(generatedAt))}</div>
